package io.vertx.kotlin.ext.metric.collect

import io.vertx.ext.metric.collect.ExtendedMetricsOptions
import io.vertx.ext.metric.collect.MetricsType

/**
 * A function providing a DSL for building [io.vertx.ext.metric.collect.ExtendedMetricsOptions] objects.
 *
 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [io.vertx.ext.metric.collect.ExtendedMetricsOptions original] using Vert.x codegen.
 */
fun ExtendedMetricsOptions(
  ...
  prefix: String? = null,
  schedule: Int? = null): ExtendedMetricsOptions = io.vertx.ext.metric.collect.ExtendedMetricsOptions().apply {
