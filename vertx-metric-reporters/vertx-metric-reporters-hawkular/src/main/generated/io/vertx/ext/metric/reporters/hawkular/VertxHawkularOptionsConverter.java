...
/**
 * Converter for {@link io.vertx.ext.metric.reporters.hawkular.VertxHawkularOptions}.
 *
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.metric.reporters.hawkular.VertxHawkularOptions} original class using Vert.x codegen.
 */
public class VertxHawkularOptionsConverter {
  ...
  public static void fromJson(JsonObject json, VertxHawkularOptions obj) {
    if (json.getValue("authenticationOptions") instanceof JsonObject) {
      obj.setAuthenticationOptions(new io.vertx.ext.metric.reporters.hawkular.AuthenticationOptions((JsonObject)json.getValue("authenticationOptions")));
    }
