...
class MetricTagsMatcher {
  ...
  MetricTagsMatcher(MetricTagsMatch match) {
    ...
    value = matchType == MetricTagsMatch.MatchType.EQUALS ? match.getValue() : null;
    pattern = matchType == MetricTagsMatch.MatchType.REGEX ? Pattern.compile(match.getValue()) : null;
  }
